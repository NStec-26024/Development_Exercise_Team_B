...
// validateRange(form.getPrice(), maxPrice, "price", "価格は100万円以下で入力してください",
// errors);
// validateRange(form.getStock(), maxStock, "stock", "在庫数は1000個以下で入力してください",
// errors);
// validateImage(form.getImage(), errors);
// }

// private void validateRange(String value, int max, String field, String
